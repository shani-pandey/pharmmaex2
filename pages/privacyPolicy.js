      ...
      <div className="container" style={{paddingTop: '56px', paddingBottom: '56px'}}>
        <div className="innerContainer mx-auto" style={{maxWidth: '1100px'}}>
          ...
          <section className="mb-5">
            ...
            <p>At PharmmaEx, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard <br/> your personal information when you visit our website or interact with our services.</p>
