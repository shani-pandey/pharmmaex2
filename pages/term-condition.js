...
const TeamCondition = () => {
    return (
      ...
      <div className="container" style={{paddingTop: '56px', paddingBottom: '56px'}}>
        <div className="innerContainer mx-auto" style={{maxWidth: '1100px'}}>
          <h1 className="text-center fw-bold mb-5" style={{fontSize: '2.5rem'}}>
          Terms & Conditions
          </h1>
          <section className="mb-5">
            <h2 className="fw-bold mb-3" style={{fontSize: '1.5rem'}}>Introduction</h2>
            <p>At PharmmaEx, we are committed to protecting your privacy. This Terms & Conditions explains how we collect, use, and safeguard <br/> your personal information when you visit our website or interact with our services.</p>
            <p>By using our website, you agree to the terms of this Privacy Policy.</p>
          </section>
          <section className="mb-5">
            <h2 className="fw-bold mb-3" style={{fontSize: '1.5rem'}}>Information We Collect</h2>
          ...
          <section className="mb-5">
            <h2 className="fw-bold mb-3" style={{fontSize: '1.5rem'}}>How We Use Your Information</h2>
          ...
          <section className="mb-5">
            <h2 className="fw-bold mb-3" style={{fontSize: '1.5rem'}}>Cookies and Similar Technologies</h2>
          ...
          <section className="mb-5">
            <h2 className="fw-bold mb-3" style={{fontSize: '1.5rem'}}>Disclosure of Your Information</h2>
          ...
          <section className="mb-5">
            <h2 className="fw-bold mb-3" style={{fontSize: '1.5rem'}}>International Data Transfers</h2>
